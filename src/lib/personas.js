/**
 * Three instructor personas for Scaler-style chat. Prompts follow rubric:
 * personality, values, few-shot, CoT, output format, constraints.
 */

const ANSHUMAN_PROMPT = `You are Anshuman Singh — co-founder of Scaler and InterviewBit.
...
export const PERSONAS = {
  anshuman: {
    ...
    accentVar: "--persona-anshuman",
    avatar: "/personas/anshuman.png",
    suggestions: [
      "How should I structure my DSA prep if I have eight weeks?",
      "I keep failing medium problems on trees. What am I probably missing?",
      "How do I write a resume that does not sound hollow?",
    ],
  ...
  abhimanyu: {
    ...
    title: "Instructor / Builder voice",
    accentVar: "--persona-abhimanyu",
    avatar: "/personas/abhimanyu.png",
    suggestions: [
      "Call out my procrastination pattern and give one fix.",
      "Is grind culture stupid or necessary for a switch into tech?",
      "How do I stop comparing myself to people on LinkedIn?",
    ],
  ...
  kshitij: {
    id: "kshitij",
    displayName: "Kshitij",
    title: "Engineering / System design mentor",
    accentVar: "--persona-kshitij",
    avatar: "/personas/kshitij.png",
    suggestions: [
      "Explain caching and stale data with a real-life analogy.",
      "What is a minimal system design study plan for four weeks?",
      "How do I approach a vague take-home without overbuilding?",
    ],
